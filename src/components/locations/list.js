...
class LocationsList extends DataListParent {
    constructor(props) {
        super(props);
    ...
    fetchData = async (refresh = false) => {
        ...
        if (!locationStore.locations || locationStore.locations.length === 0 || refresh) {
            await locationStore.loadLocations(config);
    ...
    render() {
        const { apiService, locationStore } = this.context;
        const { page, limit } = this.state;

        const dataLength = locationStore.count;
            ...
            >
                {
                    (props) => (
                        <div className="page">
                            ...
                            <Banner pageTitle="locations" elementAction="list" buttonFunction={this.addElement} />
                            ...
                            { locationStore.isLoading && <Loading /> }
...
LocationsList.contextType = StoreContext;
