...
export default class GlobalFilterCalendarContainer extends React.Component {
    ...
    getDateRangeType() {
        const { dateEnd, dateStart, type } = this.props;
                ...
                case CalendarConfig.DAILY:
                    ...
                    if (direction === 0) {
                        this.setState({
                            ...
                            setDateStartEnd(dateStart, dateStart, false);
                ...
                case CalendarConfig.WEEKLY:
                    ...
                    if (direction === 0) {
                        this.setState({
                            ...
                            setDateStartEnd(dateStart.clone().startOf("week"), dateStart.clone().endOf("week"), false);
                            this.closeDatePickersIfApplicable();
                        });
                    }
                    else {
                ...
                case CalendarConfig.MONTHLY:
                    ...
                    if (direction === 0) {
                        this.setState({
                            ...
                            setDateStartEnd(dateStart.clone().startOf("month"), dateStart.clone().endOf("month"), false);
                            this.closeDatePickersIfApplicable();
                        });
                    }
                    else {
        ...
        if (customDateStartSpecified && customDateEndSpecified) {
            if (endDate.isBefore(startDate)) {
                ...
                this.setState({
                    ...
                    this.checkIfBothCustomDatesSpecified();
                });
            }
            else {
